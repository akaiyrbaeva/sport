...
/* @var $searchModel app\models\SovernovaniyaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Жарыстар тізімі';
$this->params['breadcrumbs'][] = 'Жарыстар тізімі';
?>
                            ...
                            'buttons' => [
                                ...
                                'delete' => function ($url, $model, $key) {
                                    return Html::a('<button type="button" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" style="color:white;"></span></button>',
                                        $url, [
                                            'title' => 'Өшіру',
                                            'data-confirm' => 'Сіз шынымен ағымдағы жарысты өшіргіңіз келе ме?',
                                            'data-method' => 'post',
                                            'data-pjax' => '0',
                                        ]);
                                },
