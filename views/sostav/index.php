...
/* @var $searchModel app\models\SostavSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Қатысушылар тізімі';
$this->params['breadcrumbs'][] = 'Қатысушылар тізімі';
?>
                            ...
                            'buttons' => [
                                ...
                                'delete' => function ($url, $model, $key) {
                                    return Html::a('<button type="button" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" style="color:white;"></span></button>',
                                        $url, [
                                            'title' => 'Өшіру',
                                            'data-confirm' => 'Сіз шынымен ағымдағы қатысушыны өшіргіңіз келе ме?',
                                            'data-method' => 'post',
                                            'data-pjax' => '0',
                                        ]);
                                },
