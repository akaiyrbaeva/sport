...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <div class="row">
            ...
            <div class="col-xs-5">
                <?= Html::submitButton('Жүйеге кіру', ['class' => 'btn btn-primary btn-block btn-flat', 'name' => 'login-button']) ?>
            </div>
        </div>

        <div>
            <a href="<?= Url::to(['/site/signup'])?>">Жүйеде тіркелу</a>
        </div>

        <div>
            <a href="<?= Url::to(['/site/request-password-reset'])?>">Парольді қалпына келтіру</a>
        </div>
